...
// Change to FALSE to disable the mod.
if (FALSE) {
  // Only execute this if not already identified as banned.
  if (!$banned && empty($row['ban_exclude'])) {
    global $phpbb_root_path;
    require_once($phpbb_root_path.'includes/functions_user.php');

    $spamCheck = new ForumSpamCheck();
    #$_SERVER['REMOTE_ADDR'];
    ...
    if (empty($user_ips)) {
      ...
      $banTriggers['ip']['value'] = $_SERVER['REMOTE_ADDR'];
    }
